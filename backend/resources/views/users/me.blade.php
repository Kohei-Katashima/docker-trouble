...
<div class="container marketing mt-5">
  ...
  <div class="row">
    <div class="col-lg-4">
      ...
      <p><a class="btn btn-secondary" href="{{ route('users.edit', Auth::user()->id)}}"  role="button">編集する &raquo;</a></p>
    </div><!-- /.col-lg-4 -->
  </div><!-- /.row -->
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    @if(isset($post->image))
      <img src="{{ asset('storage/image/'.$post->image) }}"class="bd-placeholder-img mr-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
        ...
        <svg class="bd-placeholder-img mr-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em">noimage</text></svg>
      @endif
